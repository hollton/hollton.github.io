...
- 1、以角色划分，使用不同的json配置文件（COURSE_LEADER:学科，SCHOOL_CLASS_ADMIN:班主任，SCHOOL_COURSE_ADMIN:学校教研员，SCHOOL_GRADE_ADMIN:年级主任）
- 2、JSON配置：
